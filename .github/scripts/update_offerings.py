...
a README goes stale silently. In the book repository a lesson callout sat at the
top of the file for four weeks after the lesson had run, and readers kept
signing up for it. This is the same script, kept in step by hand across the two
repositories that carry the block.
...
COURSES_URL = (
    ...
    "?utm_source=github&utm_medium=readme&utm_campaign=skills&utm_content=offerings"
)
